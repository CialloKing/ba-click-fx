    ...
    const layers = [
      ...
      // 4. 主蓝色轨迹
      {
        ...
        stops: [[0.0, this.config.trail.mainAlpha * 0.04 * tf],
                ...
                [0.74, this.config.trail.mainAlpha * 0.82 * tf],
                [1.0, this.config.trail.mainAlpha * tf]],
      },
      // 5. 中心浅蓝高光
      {
